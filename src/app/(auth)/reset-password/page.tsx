...
import { QrCode, Lock, Loader2, CheckCircle2, AlertCircle } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 className="mt-6 text-3xl font-extrabold text-white tracking-tight">Set new password</h2>
        <p className="mt-2 text-sm text-slate-400">Your reset link is valid. Choose a new secure password.</p>
      </div>
